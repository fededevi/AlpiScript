...
SimpleNode::SimpleNode(Parser *parser, int id) :
     parser(parser), id(id) 
{
}
...
void* SimpleNode::jjtAccept(ParserVisitor *visitor, void* data) const
{
    return visitor->visit(this, data);
}

void SimpleNode::jjtChildrenAccept(ParserVisitor *visitor, void* data) const {
    for (int i = 0; i < children.size(); ++i) {
      children[i]->jjtAccept(visitor, data);
    }
}

void SimpleNode::jjtChildAccept(int childNo, ParserVisitor *visitor, void* data) const {
