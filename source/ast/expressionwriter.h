...
public:
    ...
    virtual void *visit(const String * node, void *data) const;
    ...
    virtual void *visit(const TypeId *node, void *data) const;
    virtual void *visit(const Parameter *node, void *data) const;
    virtual void *visit(const Method *node, void *data) const;
    virtual void *visit(const Declaration *node, void *data) const;
    virtual void *visit(const Assignment *node, void *data) const;
};
